...
class InvoiceVoidService extends BaseInvoiceService
{
     ...
     */
    public function void(): \Psr\Http\Message\ResponseInterface
    {
        return $this->service->http->post($this->service->host . "$this->endpoint/$this->invoiceId/void");
    }
}
